...
- 使用 macOS 14，Xcode_15.4 构建，移除了 bitcode 支持
...
./main.sh compile -p ios -a arm64 -l ffmpeg7 --skip-fmwk
```
...
- 您可以将所有预编译的 GitHub 库下载到自己的服务器，并在运行 install 命令前通过 MR_DOWNLOAD_BASEURL 指定您的服务器地址
